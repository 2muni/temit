...
const POST = 'snapshot_comment/POST';
const POST_SUCCESS = 'snapshot_comment/POST_SUCCESS';
const POST_FAILURE = 'snapshot_comment/POST_FAILURE';
const LIST = 'snapshot_comment/LIST';
const LIST_SUCCESS = 'snapshot_comment/LIST_SUCCESS';
const LIST_FAILURE = 'snapshot_comment/LIST_FAILURE';
const GET = 'snapshot_comment/GET';
const GET_SUCCESS = 'snapshot_comment/GET_SUCCESS';
const GET_FAILURE = 'snapshot_comment/GET_FAILURE';
const EDIT = 'snapshot_comment/EDIT';
const EDIT_SUCCESS = 'snapshot_comment/EDIT_SUCCESS';
const EDIT_FAILURE = 'snapshot_comment/EDIT_FAILURE';
const REMOVE = 'snapshot_comment/REMOVE';
const REMOVE_SUCCESS = 'snapshot_comment/REMOVE_SUCCESS';
const REMOVE_FAILURE = 'snapshot_comment/REMOVE_FAILURE';
const LIKE = 'snapshot_comment/LIKE';
const LIKE_SUCCESS = 'snapshot_comment/LIKE_SUCCESS';
const LIKE_FAILURE = 'snapshot_comment/LIKE_FAILURE';
...
export const postRequest = data => (
  dispatch => {
    dispatch(post());
    return axios.post('/api/snapshots/comments', data)
      .then((res) => {
...
export const listRequest = snapshot => (
  dispatch => {
    dispatch(list());
    return axios.get(`/api/snapshots/comments/${snapshot}`)
      .then((res) => {
...
export const getRequest = (snapshot, reply_to) => (
  dispatch => {
    dispatch(get());
    return axios.get(`/api/snapshots/comments/${snapshot}`, reply_to)
      .then((res) => {
...
export const editRequest = (comments, data) => (
  dispatch => {
    ...
    return axios.post(`/api/snapshots/comments/${comments}`, data)
      .then((res) => {
...
export const removeRequest = id => (
  dispatch => {
    dispatch(remove());
    return axios.delete(`/api/snapshots/comments/${id}`)
      .then((res) => {
