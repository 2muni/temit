...
const POST = 'article_comment/POST';
const POST_SUCCESS = 'article_comment/POST_SUCCESS';
const POST_FAILURE = 'article_comment/POST_FAILURE';
const LIST = 'article_comment/LIST';
const LIST_SUCCESS = 'article_comment/LIST_SUCCESS';
const LIST_FAILURE = 'article_comment/LIST_FAILURE';
const GET = 'article_comment/GET';
const GET_SUCCESS = 'article_comment/GET_SUCCESS';
const GET_FAILURE = 'article_comment/GET_FAILURE';
const EDIT = 'article_comment/EDIT';
const EDIT_SUCCESS = 'article_comment/EDIT_SUCCESS';
const EDIT_FAILURE = 'article_comment/EDIT_FAILURE';
const REMOVE = 'article_comment/REMOVE';
const REMOVE_SUCCESS = 'article_comment/REMOVE_SUCCESS';
const REMOVE_FAILURE = 'article_comment/REMOVE_FAILURE';
const LIKE = 'article_comment/LIKE';
const LIKE_SUCCESS = 'article_comment/LIKE_SUCCESS';
const LIKE_FAILURE = 'article_comment/LIKE_FAILURE';
